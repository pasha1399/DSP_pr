...
legend('True PSD','PSD estimate Yule-Walker method', 'PSD estimate Burg method', 'PSD estimate Covariance method', 'PSD estimate Modified Covariance method'); 
disp('%') 
disp('%') 
disp('% дКЪ ОПНДНКФЕМХЪ МЮФЛХРЕ <ENTER>') 
pause 
...
pause 
disp('%') 
disp([' лернд чкю-снкйепю:                      RMSE_YW = ' num2str(RMSE_YW)]);
disp('%') 
disp([' лернд аепцю:                            RMSE_BURG = ' num2str(RMSE_BURG)]);
disp('%') 
disp([' йнбюпхюжхнммши лернд:                   RMSE_COV = ' num2str(RMSE_COV)]);
disp('%') 
disp([' лндхтхжхпнбюммши йнбюпхюжхнммши лернд:  RMSE_MCOV = ' num2str(RMSE_MCOV)]);
disp('%') 
disp('%')
disp('% дКЪ ОПНДНКФЕМХЪ МЮФЛХРЕ <ENTER>') 
pause 
...
legend(['True PSD: p opt = ' num2str(p_opt)], ['PSD estimate Yule-Walker method: p = ' num2str(p_low)], ['PSD estimate Yule-Walker method: p = ' num2str(p_high)]); 
...
legend(['True PSD: L = ' num2str(L)], [' PSD estimate Yule-Walker method: L = ' num2str(L)], [' PSD estimate Yule-Walker method: L = ' num2str(100*L)]); 
